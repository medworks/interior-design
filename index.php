...
<body> 
    ...
    <div class="tp-banner-container" id="home">
        <div class="tp-banner">
            <ul>   
                <!-- SLIDE  -->
                <li data-transition="fade" data-slotamount="5" data-masterspeed="500" data-thumb="./images/slide/thumb1.jpg" data-saveperformance="off" data-title="Slide">
                    <!-- MAIN IMAGE -->
                ...
                <!-- SLIDE  -->
                <li data-transition="fade" data-slotamount="5" data-masterspeed="500" data-thumb="./images/slide/thumb2.jpg" data-saveperformance="off" data-title="Slide">

                    <!-- MAIN IMAGE -->
                    <img src="./images/slide/image2.jpg" alt="fullslide8" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                    <!-- END MAIN IMAGE -->
                ...
                <!-- SLIDE  -->
                <li data-transition="fade" data-slotamount="5" data-masterspeed="500" data-thumb="./images/slide/thumb3.jpg" data-saveperformance="off" data-title="Slide">

                    <!-- MAIN IMAGE -->
                    <img src="./images/slide/image3.jpg" alt="fullslide8" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                    <!-- END MAIN IMAGE -->                               
    ...
    <div class="site-wrapper" id="about">
               ...
               <!-- <div class="row">
                    ...
                    <div class="col-md-6"> -->
                        ...
                        <div class="margin-top-x2">
                            <a href="http://themeforest.net/item/larx-interior-design-studio-template/8170114" target="_blank" class="btn black-btn">Buy Now</a>
                        </div>
                    </div>
                </div>
                            ...
                            <a href="#">  -->
                                ...
                                <!-- <img src="./images/other/team_2.jpg" class="img-circle" alt="Specifie an alternate text for an image">                    
                                   ...
                                   <!-- </a><div class="t-social-holder"><a href="#">
                                            ...
                                            <a href="#"><span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x"></i><i class="fa fa-behance fa-stack-1x fa-inverse"></i></span></a>
                                        </div>
                                    </div>
                                </div>                                            
       ...
       <!-- <div class="container padding-top-x2 padding-bottom text-center"> -->
            ...
            <div class="row text-center">
                ...
                <div class="col-sm-4">
                    <div class="thumbnail price-table price-table-black">                                
                        <div class="caption">
                            <h3>Basic</h3>
                            <br>
                            <h1>$500</h1>                                
                            ...
                            <div class="space-bottom-2x"></div>                                    
                            <p>Vivamus ullamcorper sed</p>
                            <p>Suspendisse porttitor</p>
                            <p>Cras pretium tortor</p>
                            <p>Vivamus consectetur velit</p>
                            <div class="space-bottom-2x"></div>
                            <a href="#" class="btn black-btn">Buy Now</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="padding-top-x2 padding-bottom container text-center">  -->
               ...
               <!--  <div class="general-title general-title-black">
                ...
                <div class="row">                                
                    ...
                    <div id="owl-demo">
                        <a href="#"><img src="./images/other/client_1.png" alt="Owl Image"></a>
                        <a href="#"><img src="./images/other/client_2.png" alt="Owl Image"></a>
                        <a href="#"><img src="./images/other/client_3.png" alt="Owl Image"></a>
                        <a href="#"><img src="./images/other/client_4.png" alt="Owl Image"></a>
                        <a href="#"><img src="./images/other/client_5.png" alt="Owl Image"></a>
                        <a href="#"><img src="./images/other/client_6.png" alt="Owl Image"></a>
                        <a href="#"><img src="./images/other/client_3.png" alt="Owl Image"></a>
                        <a href="#"><img src="./images/other/client_4.png" alt="Owl Image"></a>
                    </div>                                
